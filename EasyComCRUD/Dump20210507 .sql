...
--
-- Host: localhost    Database: gerenciamento_easy
-- ------------------------------------------------------
...
CREATE TABLE `cadastros` (
  ...
  `E-mail` varchar(20) DEFAULT '@easycomtech.com',
  `Sexo` enum('M','F','O') DEFAULT NULL,
  `Nascimento` date DEFAULT NULL,
  `Logadouro` varchar(40) DEFAULT NULL,
  `Cidade` varchar(30) NOT NULL,
  `Estado` varchar(2) NOT NULL,
  `cursos` varchar(10) DEFAULT NULL,
...
-- Dump completed on 2021-05-07  9:47:16
